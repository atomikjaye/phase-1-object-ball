      ...
      if (teamInfoKey === "players") {
        for (let playerKey in gameObj[singleTeamKey][teamInfoKey]) {
          ...
          if (currentPoints > highestPoints) {
            ...
            if (DEBUG) console.log(gameObj[singleTeamKey][teamInfoKey][playerKey].points, playerKey)
          }
        }
      }
    }
...
console.log("Points Scored Bismak Biyombo Test1: ", numPointsScored('Bismak Biyombo'))
console.log("Points Scored Jeff Adrien Test2: ", numPointsScored('Jeff Adrien'))
// console.log("Points Scored Test3: ", numPointsScoredClass('Jeff Adrien'))
console.log("Shoe Size Brook Lopez Test1: ", shoeSize('Brook Lopez'))
console.log("Shoe Size Bismak Biyombo Test2: ", shoeSize('Bismak Biyombo'))
console.log("Team Colors: ", teamColors('Brooklyn Nets'))
console.log("Team Colors: ", teamColors('Charlotte Hornets'))
console.log("Team names: ", teamNames())
console.log("Player Numbers Brooklyn Nets Test1: ", playerNumbers('Brooklyn Nets'))
console.log("Player Numbers Charlotte Hornets Test2: ", playerNumbers('Charlotte Hornets'))
console.log("Player Stats Brendan Haywood Test1: ", playerStats('Brendan Haywood'))
console.log("Player Stats Mason Plumlee Test2: ", playerStats('Mason Plumlee'))
console.log("Biggest Shoe Rebounds: ", bigShoeRebounds())
